...
const UserHeader = () => {
    ...
    return ( 
        <div className="header flex flex-row h-16 border-b-2 border-highlights bg-black">
            <Link to="/user-log" className="text-highlights w-1/3 flex items-center px-24">logo</Link>
            <ul className="text-white w-2/3 list-none flex flex-row gap-20 items-center justify-center ">
                ...
                <button onClick={handleSignOut} className="text-white bg-highlights rounded-full px-3 py-2">sign out</button>
                <ProfilePicture /> 
            </ul>
